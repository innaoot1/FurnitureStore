...
namespace FurnitureStore
{
    public static class BackupManager
    {
        public static string CreateBackup()
        {
            ...
            string fileName =
                $"db70_backup_{DateTime.Now:yyyy-MM-dd_HH-mm-ss}.sql";
            ...
            {
                sw.WriteLine("CREATE DATABASE IF NOT EXISTS `db70`;");
                sw.WriteLine("USE `db70`;");
                sw.WriteLine();
        ...
        public static void CreateStructureBackup()
        {
            ...
            string fileName =
                $"db70_structure_{DateTime.Now:yyyy-MM-dd_HH-mm-ss}.sql";
