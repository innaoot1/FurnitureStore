    ...
    public partial class ManagementDB : Form
    {
        ...
        private void buttonExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (MySqlConnection con =
                    new MySqlConnection(
                        connStr.GetConnectionString("db70")))
                {
                    con.Open();
        ...
        private void buttonImport_Click(object sender, EventArgs e)
        {
            try
            {
                        ...
                        connStr.GetConnectionString("db70")))
                {
                    ...
                    {
                        MessageBox.Show(
                            $"Выбранный файл не соответствует таблице \"{table}\".\n\n" +
                            $"Вероятно, данный файл был экспортирован из другой таблицы базы данных.\n\n" +
                            $"Выберите CSV-файл, созданный для таблицы \"{table}\".",
        ...
        private void buttonStructure_Click(object sender, EventArgs e)
        {
            try
            {
                        ...
                        $"server={host};uid={uid};pwd={pwd};"))
                {
                    ...
                    MySqlCommand create =
                        new MySqlCommand(
                            "CREATE DATABASE db70 CHARACTER SET utf8mb4;",
                            con);
